  ...
  if (!contact) {
    return (
      <div className="flex flex-col flex-1 w-full min-w-0 p-12 bg-white">
        ...
        <Link href="/logged/pages/management/sm/contacts_db" className="text-blue-600 hover:underline mt-4">
          ← Volver a Contactos
        </Link>
      </div>
    );
    ...
    <div className="flex flex-col flex-1 min-h-0 w-full min-w-0 bg-white overflow-hidden">
      ...
      <div className="flex-shrink-0 w-full flex items-center justify-between gap-4 bg-blue-950/90 px-6 py-4 text-white">
        <div className="flex items-center gap-4 min-w-0">
          <button
            type="button"
            onClick={() => router.push("/logged/pages/management/sm/contacts_db")}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                ...
                {contact.id_customer && (
                  <div className="lg:col-span-3">
                    ...
                    <button
                      type="button"
                      onClick={() => router.push(`/logged/pages/management/sm/customers_db/${contact.id_customer}`)}
