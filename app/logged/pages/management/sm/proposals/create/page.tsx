...
const CreateProposalPage: FC = () => {
  ...
  const backUrl = "/logged/pages/management/sm/proposals";
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  ¿No existe la cuenta?{" "}
                  <Link href="/logged/pages/management/sm/customers_db/create" className="text-blue-600 hover:underline">
                    Crear cuenta
                  </Link>
                </p>
              </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  ...
                  <Link href="/logged/pages/management/sm/contacts_db/create" className="text-blue-600 hover:underline">
                    Crear contacto
                  </Link>
                </p>
              </div>
