  ...
  if (!publication) {
    return (
      <div className="flex flex-col w-full p-12">
        ...
        <Link href="/logged/pages/management/publications_management" className="text-blue-600 hover:underline mt-4">
  ...
  return (
    <div className="flex flex-col w-full min-w-0 bg-white min-h-screen">
      <div className="w-full text-center bg-blue-950/70 p-5 text-white flex items-center justify-center gap-4">
        <button
          type="button"
          onClick={() => router.push("/logged/pages/management/publications_management")}
