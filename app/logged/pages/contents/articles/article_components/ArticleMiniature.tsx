...
const ArticleMiniature: FC<ArticleMiniatureProps> = ({
  ...
  return (
    <Link href={`/logged/pages/contents/articles/${id_article}`} className="flex flex-col shadow-xl cursor-pointer w-80 p-2 border-t border-gray-100 bg-gray-100/50 hover:bg-white h-96">
