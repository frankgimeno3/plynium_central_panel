...
const PublicationFilterContent: FC<PublicationFilterProps> = ({ }) => {
  ...
  const getFilterHref = () => {
    ...
    return queryString ? `/logged/pages/account-management/contents/publications/search?${queryString}` : '/logged/pages/account-management/contents/publications/search';
  };
