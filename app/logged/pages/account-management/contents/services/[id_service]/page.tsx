  ...
  if (!service) {
    return (
      <div className="flex flex-col w-full p-12">
        ...
        <Link href="/logged/pages/account-management/contents/services" className="text-blue-600 hover:underline mt-4">
          ← Back to Services
        </Link>
      </div>
    );
  ...
  return (
    <div className="flex flex-col w-full bg-white min-h-screen">
      <div className="text-center bg-blue-950/70 p-5 text-white flex items-center justify-center gap-4">
        <button
          type="button"
          onClick={() => router.push("/logged/pages/account-management/contents/services")}
