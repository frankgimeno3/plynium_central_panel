  ...
  return (
    <div className="flex flex-col w-full bg-white">
      <div className="flex flex-col text-center bg-blue-950/70 p-5 px-46 text-white relative">
        ...
        <button
          type="button"
          onClick={() => router.push('/logged/pages/account-management/directory/companies/create')}
                ...
                {filteredCompanies.length === 0 ? (
                  ...
                  filteredCompanies.map((company) => (
                    <tr
                      ...
                      onClick={() => router.push(`/logged/pages/account-management/directory/companies/${company.companyId}`)}
