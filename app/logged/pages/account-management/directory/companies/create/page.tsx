...
type FormErrors = Partial<Record<keyof CompanyForm | 'portals', string>>;
...
const CreateCompanyProfile: FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/logged/pages/account-management/directory/companies');
      router.refresh();
    } catch (error: unknown) {
      const msg =
        typeof error === 'string'
  ...
  return (
    <div className="flex flex-col w-full flex-1 min-h-0 bg-white">
      <div className="flex flex-col text-center bg-blue-950/70 p-5 px-46 text-white relative shrink-0">
        ...
        <button
          type="button"
          onClick={() => router.push('/logged/pages/account-management/directory/companies')}
