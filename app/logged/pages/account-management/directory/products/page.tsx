  ...
  return (
    <div className="flex flex-col w-full bg-white">
      <div className="flex flex-col text-center bg-blue-950/70 p-5 px-46 text-white relative">
        ...
        <button
          type="button"
          onClick={() => router.push('/logged/pages/account-management/directory/products/create')}
                ...
                {filteredProducts.length === 0 ? (
                  ...
                  filteredProducts.map((product) => (
                    <tr
                      ...
                      onClick={() => router.push(`/logged/pages/account-management/directory/products/${product.productId}`)}
