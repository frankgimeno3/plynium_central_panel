...
import { decodeForecastedIssueId } from "@/app/logged/pages/production/publications/magazines/flatplans/forecastedIssueRoute";

const BASE = "/logged/pages/production/publications/magazines/flatplans";
