...
export const ArticleSubpagePageFormatSection: FC<ArticleSubpagePageFormatSectionProps> = ({
  ...
  return (
    <section className="rounded-xl border border-gray-200 bg-white p-4">
      <h2 className="text-sm font-semibold text-gray-800">Article page format</h2>
      <p className="text-xs text-gray-500 mb-3">
        Applies to every page of this article. Body chunks flow in the chosen column layout below
        the title and subtitle band.
      </p>
