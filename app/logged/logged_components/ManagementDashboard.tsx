                  ...
                  {getPmEventsForDate(selectedDay).length === 0 ? <p className="text-gray-500">No events scheduled for this day</p> : (
                    <div className="space-y-4">
                      {getPmEventsForDate(selectedDay).map((ev) => (
                        <div key={ev.id_event} onClick={() => router.push(`${PROJECTS_PATH}/${ev.id_project}`)} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer hover:bg-blue-50/50">
              ...
              <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedEvents.map((ev) => (
                    <tr key={ev.id_event} onClick={() => router.push(`${PROJECTS_PATH}/${ev.id_project}`)} className="hover:bg-blue-50/80 cursor-pointer">
