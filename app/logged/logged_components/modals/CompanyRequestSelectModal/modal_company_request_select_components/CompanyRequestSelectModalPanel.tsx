...
import { formatCompanyRequestDate } from "./format_company_request_date";

type Props = {
  onClose: () => void;
  pendingRequests: CompanyRequest[];
  selectedRequest: CompanyRequest | null;
  onSelectRow: (r: CompanyRequest) => void;
  onConfirm: () => void;
};

export const CompanyRequestSelectModalPanel: FC<Props> = ({
  onClose,
  pendingRequests,
  selectedRequest,
  onSelectRow,
  ...
  >
    ...
    >
      <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
        <h2 id="company-request-select-modal-title" className="text-xl font-bold text-gray-800">
                ...
                pendingRequests.map((req) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {formatCompanyRequestDate(req.request_date)}
                    </td>
                  </tr>
                ))
              )}
